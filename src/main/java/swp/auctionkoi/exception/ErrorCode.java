...
//    USERNAME_INVALID(1002, "Username must be ....", HttpStatus.BAD_REQUEST),
    ...
    BREEDER_NOT_FOUND(1015, "Breeder not found!", HttpStatus.NOT_FOUND),
    ...
    INSUFFICIENT_FUNDS(1021, "Insufficient funds!", HttpStatus.BAD_REQUEST),
    ...
    INVALID_WALLET_ID(1029, "Invalid wallet id!", HttpStatus.BAD_REQUEST),
    ...
    INVALID_INCREMENT_PRICE(1037, "Invalid increment price!", HttpStatus.BAD_REQUEST),
    INVALID_START_PRICE(1038, "Invalid start price!", HttpStatus.BAD_REQUEST),
    INVALID_START_TIME(1039, "Start time is after end time!", HttpStatus.BAD_REQUEST),
    START_TIME_TOO_CLOSED(1040, "Start time is too closed, start time must be at least one day from current time!", HttpStatus.BAD_REQUEST),
    CANT_CANCEL_REQUEST(1041, "Your request or fish is invalid!", HttpStatus.BAD_REQUEST),
    INVALID_AUCTION_REQUEST_AND_FISH_STATE(1042, "Your request and fish have invalid state!", HttpStatus.BAD_REQUEST),
    AUCTION_PATICIPANTS_NOT_FOUND(1043, "Auction participants not found!", HttpStatus.NOT_FOUND),
    WINNER_NOT_EXISTED(1044, "Auction have no winner", HttpStatus.NOT_FOUND),
    USER_NOT_IN_AUCTION(1045, "You not in auction", HttpStatus.NOT_FOUND),
